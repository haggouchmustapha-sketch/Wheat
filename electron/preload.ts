...
const wheat = {
  ...
  /** Stock. Reads and drafting are ordinary calls; validation and
   * contrepassation are the two that move stock, and each runs as one
   * transaction in the main process. */
  getStockWorkspace: (payload: unknown) => ipcRenderer.invoke("wheat:stock:workspace", payload),
  getStockState: (payload: unknown) => ipcRenderer.invoke("wheat:stock:state", payload),
  getStockCard: (payload: unknown) => ipcRenderer.invoke("wheat:stock:card", payload),
  getStockMovement: (payload: unknown) => ipcRenderer.invoke("wheat:stock:movement", payload),
  getStockDocuments: (payload: unknown) => ipcRenderer.invoke("wheat:stock:documents", payload),
  getStockDocument: (payload: unknown) => ipcRenderer.invoke("wheat:stock:document", payload),
  saveStockDocument: (payload: unknown) => ipcRenderer.invoke("wheat:stock:document:save", payload),
  deleteStockDocument: (payload: unknown) => ipcRenderer.invoke("wheat:stock:document:delete", payload),
  previewStockValidation: (payload: unknown) => ipcRenderer.invoke("wheat:stock:document:preview-validation", payload),
  validateStockDocument: (payload: unknown) => ipcRenderer.invoke("wheat:stock:document:validate", payload),
  reverseStockDocument: (payload: unknown) => ipcRenderer.invoke("wheat:stock:document:reverse", payload),
  saveStockArticle: (payload: unknown) => ipcRenderer.invoke("wheat:stock:article:save", payload),
  saveStockFamily: (payload: unknown) => ipcRenderer.invoke("wheat:stock:family:save", payload),
  saveStockUnit: (payload: unknown) => ipcRenderer.invoke("wheat:stock:unit:save", payload),
  saveStockUnitConversion: (payload: unknown) => ipcRenderer.invoke("wheat:stock:unit-conversion:save", payload),
  deleteStockUnitConversion: (payload: unknown) => ipcRenderer.invoke("wheat:stock:unit-conversion:delete", payload),
  saveStockWarehouse: (payload: unknown) => ipcRenderer.invoke("wheat:stock:warehouse:save", payload),
  saveStockLot: (payload: unknown) => ipcRenderer.invoke("wheat:stock:lot:save", payload),
  getStockLots: (payload: unknown) => ipcRenderer.invoke("wheat:stock:lots", payload),
  saveStockSettings: (payload: unknown) => ipcRenderer.invoke("wheat:stock:settings:save", payload),
  saveStockAccountMapping: (payload: unknown) => ipcRenderer.invoke("wheat:stock:mapping:save", payload),
  deleteStockAccountMapping: (payload: unknown) => ipcRenderer.invoke("wheat:stock:mapping:delete", payload),
  /** Inventaire physique: freeze, count, review, validate. */
  getStockCampaigns: (payload: unknown) => ipcRenderer.invoke("wheat:stock:inventory:list", payload),
  getStockCampaign: (payload: unknown) => ipcRenderer.invoke("wheat:stock:inventory:get", payload),
  createStockCampaign: (payload: unknown) => ipcRenderer.invoke("wheat:stock:inventory:create", payload),
  freezeStockCampaign: (payload: unknown) => ipcRenderer.invoke("wheat:stock:inventory:freeze", payload),
  saveStockCampaignCounts: (payload: unknown) => ipcRenderer.invoke("wheat:stock:inventory:count", payload),
  setStockCampaignStatus: (payload: unknown) => ipcRenderer.invoke("wheat:stock:inventory:status", payload),
  validateStockCampaign: (payload: unknown) => ipcRenderer.invoke("wheat:stock:inventory:validate", payload),
  /** Dépréciations: recorded and released, never edited. */
  getStockImpairments: (payload: unknown) => ipcRenderer.invoke("wheat:stock:impairment:list", payload),
  previewStockImpairment: (payload: unknown) => ipcRenderer.invoke("wheat:stock:impairment:preview", payload),
  saveStockImpairment: (payload: unknown) => ipcRenderer.invoke("wheat:stock:impairment:save", payload),
  reverseStockImpairment: (payload: unknown) => ipcRenderer.invoke("wheat:stock:impairment:reverse", payload),
  /** Import: the preview writes nothing, the confirmation writes all or none. */
  previewStockImport: (payload: unknown) => ipcRenderer.invoke("wheat:stock:import:preview", payload),
  confirmStockImport: (payload: unknown) => ipcRenderer.invoke("wheat:stock:import:confirm", payload),
  getStockValuationReport: (payload: unknown) => ipcRenderer.invoke("wheat:stock:report:valuation", payload),
  getStockMovementReport: (payload: unknown) => ipcRenderer.invoke("wheat:stock:report:movements", payload),
  getStockVarianceReport: (payload: unknown) => ipcRenderer.invoke("wheat:stock:report:variance", payload),
  getStockAnomalyReport: (payload: unknown) => ipcRenderer.invoke("wheat:stock:report:anomalies", payload),
  getStockAgeingReport: (payload: unknown) => ipcRenderer.invoke("wheat:stock:report:ageing", payload),
